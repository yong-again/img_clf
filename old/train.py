...
def run(model, train_loader, val_loader=None, epochs=10, learning_rate=0.001, device=None, save_dir='checkpoints'):
        # 1. Device 설정
    ...
    for epoch in range(epochs):
        ...
        writer.add_scalar('Losstrain', train_loss, epoch)
...
if __name__ == '__main__':
    ...
    multiprocessing.freeze_support()  # PyInstaller 등에서 필요
    multiprocessing.set_start_method('spawn')  # Windows 필수
    ...
    # 모델 선택 (ResNet50, ResNet18, EfficientNet-B0 중 하나)
    model = resnet50(weights=ResNet50_Weights.IMAGENET1K_V2)  # 또는 resnet18(), efficientnet_b0()
